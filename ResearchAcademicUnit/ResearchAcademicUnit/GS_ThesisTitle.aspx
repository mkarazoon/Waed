                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <asp:RadioButtonList ID="rdLangType" runat="server" RepeatDirection="Horizontal" Width="100%">
                                <asp:ListItem Value="A" Selected="True"><span class="mr-2">عربي</span></asp:ListItem>
                                <asp:ListItem Value="E" Selected="False"><span class="mr-2">انجليزي</span></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row">
