<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConferenceRequestForm.aspx.cs" Inherits="ResearchAcademicUnit.ConferenceRequestForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin: 100px auto; padding: 2%">
        <div class="TitleDiv">
            نموذج طلب اشتراك في مؤتمر علمي
        </div>
        <div>
            <table class="auto-style1" dir="rtl" border="1">
                ...
                <tr>
                    <td>أسماء الباحثين المشاركين</td>
                ...
                <tr>
                    <td>طبيعة المساهمة في المؤتمر</td>
                ...
                <tr>
                    <td>تصنيف المؤتمر</td>
                    <td class="auto-style2">Conference Ranking</td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:CheckBoxList ID="CheckBoxList2" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1">اقليمي</asp:ListItem>
                            <asp:ListItem Value="2">دولي</asp:ListItem>
                            <asp:ListItem Value="3">محلي</asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
                </tr>
                <tr>
