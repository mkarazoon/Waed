...
{
    public partial class ReCertificate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(!IsPostBack)
            {
                ...
                //    + " level" + "</p>";
                EText.InnerHtml +=Session["certText"].ToString();//"<p style='font-size:24px'>" + "held for " + Session["CourseHour"].ToString().Substring(0, 1) + "  training hours" + " on " + Session["CourseDate"].ToString() + "</p>";
                //EText.InnerHtml += "<div style='float:right;text-align:left;margin-top:20px'> <p>MEU President</p>";
                //EText.InnerHtml += "<p>Prof. Mohammad Al Hileh</p></div>";
                //EText.InnerHtml += "<div style='float:left;text-align:left;margin-top:20px'> <p>"+DateTime.Now.Date.ToString("dd/MM/yyyy")+"</p>";
